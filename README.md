...
- **rmap** — Semantic repository mapping tool for AI coding agents (TypeScript)
- Contributing to **Composio Agent Orchestrator** (open-source agentic coding platform with 5.3k+ stars)
